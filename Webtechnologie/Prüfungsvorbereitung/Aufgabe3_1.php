<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"  href="Aufgabe3_1.css" title="style1"/>
	</head>
	...
	<script type="text/javascript">
		...
		function startAjax(form) {
			"use strict";
			let param = 'Aufgabe3_2.php?zahl=' + form.zahl.value;
			//alert(param);
...
<body>
	<h3>3. Aufgabe, Quersumme</h3>

	<form>
		<fieldset>
			<legend>Eingabe</legend>
			Zahl <input type="number" name="zahl" id="zahl" min="0" value="12" />
		</fieldset>
